...
import { Heart, Share2, Eye, MessageCircle, User, Bookmark, BookmarkCheck } from "lucide-react";
    ...
    <>
      ...
      >
        <Link
          ...
          className="block relative w-full h-full bg-white dark:bg-slate-900/80 backdrop-blur-xl rounded-apple overflow-hidden border border-black/5 dark:border-white/10 shadow-apple hover:shadow-2xl transition-all duration-500 flex flex-col min-h-12"
          style={{
            boxShadow: isHovered
        ...
        >
            ...
            <div className="absolute inset-0 p-4 sm:p-5">
              ...
              <div className="flex items-start justify-between">
                ...
                <motion.div
                  ...
                  className="flex items-center gap-2 px-2 py-2 bg-white/95 dark:bg-slate-800/95 backdrop-blur-xl rounded-apple shadow-sm border border-black/5 dark:border-white/10"
                >
                  <div className="w-7 h-6 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-xl flex items-center justify-center shadow-sm">
                ...
                <motion.div
                  ...
                  className="flex items-center gap-2 px-2 py-2 bg-black/70 backdrop-blur-xl rounded-apple text-white shadow-sm"
                >
              ...
              <div className="absolute bottom-4 sm:bottom-5 left-4 sm:left-5 right-4 sm:right-5 flex items-end justify-between">
                ...
                <div className="flex items-center gap-3">
                  <motion.div
                    ...
                    className="px-2 py-1.5 bg-white/90 dark:bg-slate-800/90 backdrop-blur-xl rounded-apple text-sm font-medium text-gray-700 dark:text-gray-300 shadow-sm border border-black/5 dark:border-white/10"
                  >
                    {formattedDate}
                  </motion.div>
                  ...
                  {journal.mood && (
                    <motion.div
                      ...
                      className="flex items-center text-sm gap-2 px-2 py-1.5 rounded-apple text-white font-medium shadow-xl backdrop-blur-sm"
                      style={{
          ...
          <div className="p-4 sm:p-6 space-y-4 flex-1 flex flex-col min-h-0">
            ...
            <div className="space-y-3 flex-shrink-0">
              <motion.h3
                className="text-xl sm:text-2xl font-extrabold text-gray-900 dark:text-gray-100 line-clamp-2 leading-snug"
                style={{
              ...
              {journal.tags && journal.tags.length > 0 && (
                <div className="flex flex-wrap gap-2 mt-3 border-t border-gray-100 dark:border-slate-800 pt-3">
                  {journal.tags.slice(0, 3).map((tag, index) => (
                    <motion.span
                      ...
                      className="inline-flex items-center px-2.5 py-1 text-xs sm:text-sm font-medium rounded-lg bg-gray-100 dark:bg-slate-800 text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-slate-700"
                    >
                      #{tag}
                    </motion.span>
                  ))}
                  {journal.tags.length > 3 && (
                    <span className="inline-flex items-center px-2.5 py-1 text-xs sm:text-sm font-medium rounded-lg bg-gray-50 dark:bg-slate-800/50 text-gray-500 dark:text-gray-400">
                      +{journal.tags.length - 3}
                    </span>
                  )}
                </div>
            ...
            <div className="flex-1 flex flex-col min-h-0">
              <p className="text-md text-gray-600 dark:text-gray-400 line-clamp-4 flex-1">
                {textPreview}
              </p>
              ...
              <div className="flex items-center justify-between pt-4 border-t border-gray-100 dark:border-slate-800 mt-4 flex-shrink-0">
                ...
                <div className="flex items-center">
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className={`flex items-center gap-1.5 p-3 rounded-apple transition-all duration-200 min-h-12 ${
                      isLiked
                  ...
                  <motion.div
                    ...
                    className="flex items-center gap-1.5 p-3 rounded-apple hover:bg-gray-100 dark:hover:bg-slate-800 text-gray-600 dark:text-gray-400 transition-all duration-200 min-h-12 cursor-pointer focus:ring-2 ring-blue-500"
                  ...
                  <motion.button
                    ...
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className={`flex items-center gap-1.5 p-3 rounded-apple hover:bg-gray-100 dark:hover:bg-slate-800 text-gray-600 dark:text-gray-400 transition-all duration-200 min-h-12 focus:ring-2 ring-blue-500`}
                ...
                {/* Read More */}
                <motion.div
                  className="flex items-center text-blue-500 dark:text-blue-400 font-medium text-sm sm:text-base"
                  whileHover={{ x: 4 }}
