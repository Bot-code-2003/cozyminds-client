  ...
  <div className="min-h-screen bg-gray-50 dark:bg-slate-900 flex items-center justify-center">
    <div className="flex flex-col items-center gap-4 bg-white dark:bg-slate-800 px-8 py-12 rounded-2xl shadow-xl border border-gray-200 dark:border-slate-700">
      ...
      <div className="text-center">
        <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-1">Loading profile</h3>
        <p className="text-sm text-gray-500 dark:text-gray-400">Getting user information...</p>
      </div>
    </div>
  </div>
)
...
const ErrorState = ({ error, onRetry }) => (
  <div className="min-h-screen bg-gray-50 dark:bg-slate-900 flex items-center justify-center">
    <div className="text-center p-8 bg-white dark:bg-slate-800 rounded-2xl shadow-xl border border-gray-200 dark:border-slate-700 max-w-md">
      ...
      <h2 className="text-xl font-bold mb-3 text-gray-900 dark:text-gray-100">Profile Not Found</h2>
...
const ProfileHeader = ({ profile, isSubscribed, subscribing, canSubscribe, onSubscribe }) => {
  ...
  return (
    <motion.div
      className="bg-white dark:bg-slate-800 rounded-2xl shadow-lg border border-gray-200 dark:border-slate-700 overflow-hidden mb-8"
    ...
    >
      ...
      <div className="px-6 sm:px-8 pb-8">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-end gap-6 -mt-16 relative z-10">
          {/* Avatar */}
          <motion.div
            className="w-32 h-32 bg-gradient-to-br from-purple-500 to-pink-500 rounded-2xl flex items-center justify-center text-white text-4xl font-bold shadow-xl border-4 border-white dark:border-slate-800 flex-shrink-0"
        ...
        >
          <div className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 p-4 rounded-xl border border-blue-200 dark:border-blue-800">
            ...
            <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">{profile.subscriberCount || 0}</p>
          </div>
          ...
          <div className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 p-4 rounded-xl border border-green-200 dark:border-green-800">
            ...
            <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">{profile.journalCount || 0}</p>
          </div>
    ...
    return (
      ...
      >
        ...
        <div className="max-w-md mx-auto space-y-4">
          <h3 className="text-2xl font-bold text-gray-900 dark:text-gray-100">No public journals yet</h3>
          <p className="text-gray-500 dark:text-gray-400 leading-relaxed">
            This writer hasn't shared any public journals yet. Check back later for new stories and insights!
          </p>
        </div>
      </motion.div>
    )
...
const PublicProfile = () => {
  ...
  const fetchProfile = useCallback(async () => {
    ...
    try {
      ...
      const normalizedJournals = (response.data.journals || []).map(journal => ({
        ...journal,
        createdAt: journal.createdAt || journal.date || new Date().toISOString(), // Fallback to date or current time
      }))
          ...
          <div>
            ...
            >
              <div className="flex items-center gap-4">
                <h2 className="text-3xl font-bold text-gray-900 dark:text-gray-100">Public Journals</h2>
                {journals.length > 0 && (
            ...
            <JournalsSection journals={journals} onLike={handleLike} onShare={handleShare} currentUser={currentUser} />
          </div>
        </div>
        {modals}
      </div>
