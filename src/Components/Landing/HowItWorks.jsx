    ...
    <section className="w-full max-w-7xl mx-auto px-4 sm:px-6 py-16 sm:py-24 relative overflow-hidden">
      ...
      <div className="grid gap-8 lg:grid-cols-2 relative z-10">
        {features.map((feature, index) => (
          <div
            key={index}
            className={`group relative overflow-hidden rounded-3xl border-2 ${feature.borderColor} transition-all duration-700 hover:scale-[1.02] hover:shadow-2xl bg-white/60 dark:bg-[#2A2A2A]/60 backdrop-blur-md`}
          ...
          >
            ...
            <div className="relative z-10 p-8">
              ...
              <div className="flex items-center gap-4 mb-6">
                <div
                  className={`w-14 h-14 rounded-2xl flex items-center justify-center ${feature.iconBg} text-white shadow-lg group-hover:scale-110 group-hover:rotate-3 transition-all duration-300`}
                >
                  {feature.icon}
                </div>
                <div>
